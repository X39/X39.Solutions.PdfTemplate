...
[Collection("Samples")]
public class BackgroundForegroundSample : SampleBase
{
    [Fact]
            ...
            Encoding.UTF8.GetBytes(
                $$"""
                  ...
                  <template xmlns="{{Constants.ControlsNamespace}}">
                      ...
                      <background>
                        <text margin="0 45% 0 0" foreground="#00000022" fontsize="60">BACKGROUND</text>
                      </background>
                      <foreground>
                        <text margin="0 55% 0 0" foreground="#00000022" fontsize="60">FOREGROUND</text>
                      </foreground>
                      <header>
