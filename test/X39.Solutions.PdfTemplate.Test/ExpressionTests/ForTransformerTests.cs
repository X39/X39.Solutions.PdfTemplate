...
public class ForTransformerTests
{
    ...
    public void ForLoopWithNumbers(int start, int end, int? step, int expected)
    {
        const string ns = Constants.ControlsNamespace;
    ...
    [InlineData(0, 10, 2, 5)]
    [InlineData(10, 0, -1, 10)]
    public void ForLoopWithFunctions(int start, int end, int? step, int expected)
    {
        const string ns = Constants.ControlsNamespace;
    ...
    [InlineData(0, 10, 2, 5)]
    [InlineData(10, 0, -1, 10)]
    public void ForLoopWithVariables(int start, int end, int? step, int expected)
    {
        const string ns = Constants.ControlsNamespace;
        var stepString = step is null ? string.Empty : @"step step";
        var template = $$"""
